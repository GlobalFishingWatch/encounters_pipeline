...
class ComputeEncounters(PTransform):
    ...
    def _try_to_create_encounter(self, adjacency_run):
        ...
        if (
            ...
            # Workaround to account for encounters that may span across day boundaries.
            and start_time < (end_of_day - min_duration)  # not near day end
            and end_time > (start_of_day + min_duration)  # not near day start
        ):
            return
