    ...
    def _get_nerfed_multi_expected(self):
        return [
            encounter.RawEncounter(
                ...
                vessel_2_seg_id=b"1",
                start_time=datetime.datetime(2011, 1, 1, 15, 40, tzinfo=pytz.UTC),
                end_time=datetime.datetime(2011, 1, 1, 16, 10, tzinfo=pytz.UTC),
                mean_latitude=0.0,
                mean_longitude=0.001,
                median_distance_km=0.11119492664455874,
                median_speed_knots=0.0,
                vessel_1_point_count=4,
                vessel_2_point_count=4,
                start_lat=0.0,
                start_lon=0.001,
                end_lat=0.0,
                end_lon=0.001,
            ...
            encounter.RawEncounter(
                vessel_1_seg_id=b"3",
                vessel_2_seg_id=b"1",
                start_time=datetime.datetime(2011, 1, 1, 16, 40, tzinfo=pytz.UTC),
                end_time=datetime.datetime(2011, 1, 1, 17, 40, tzinfo=pytz.UTC),
                mean_latitude=0.0,
                mean_longitude=0.00014285714285270238,
                median_distance_km=0.0,
                median_speed_knots=0.0,
